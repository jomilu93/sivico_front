    ...
    if st.form_submit_button('Analizar'):
        ...
        try:
            ...
            for senator in matches:
                ...
                topics["Educacion"] = len(senator['Educacion_initiative_list'].split("', '")) if not senator['Educacion_initiative_list'] is None or senator['Educacion_initiative_list'] == "set()" else 0
                ...
                topics["Gobernacion"] = len(senator['Gobernacion_initiative_list'].split("', '")) if not senator['Gobernacion_initiative_list'] is None or senator['Gobernacion_initiative_list'] == "set()" else 0
                topics["Igualdad de genero"] = len(senator['Para_la_Igualdad_de_Genero_initiative_list'].split("', '")) if not senator['Para_la_Igualdad_de_Genero_initiative_list'] is None or senator['Para_la_Igualdad_de_Genero_initiative_list'] == "set()" else 0
                ...
                topics["Derechos de Jovenes"] = len(senator['Derechos_de_la_Ninez_y_de_la_Adolescencia_initiative_list'].split("', '")) if not senator['Derechos_de_la_Ninez_y_de_la_Adolescencia_initiative_list'] is None or senator['Derechos_de_la_Ninez_y_de_la_Adolescencia_initiative_list'] == "set()" else 0
                ...
                topics["Economia"] = len(senator['Economia_initiative_list'].split("', '")) if not senator['Economia_initiative_list'] is None or senator['Economia_initiative_list'] == "set()" else 0
                topics["Medio ambiente"] = len(senator['Medio_Ambiente__Recursos_Naturales_y_Cambio_Climatico_initiative_list'].split("', '")) if not senator['Medio_Ambiente__Recursos_Naturales_y_Cambio_Climatico_initiative_list'] is None or senator['Medio_Ambiente__Recursos_Naturales_y_Cambio_Climatico_initiative_list'] == "set()" else 0
                topics["Hacienda y Credito Publico"] = len(senator['Hacienda_y_Credito_Publico_initiative_list'].split("', '")) if not senator['Hacienda_y_Credito_Publico_initiative_list'] is None or senator['Hacienda_y_Credito_Publico_initiative_list'] == "set()" else 0
                ...
                topics["Agricultura, Ganaderia y Pesca"] = len(senator['Agricultura__Ganaderia__Pesca_y_Desarrollo_Rural_initiative_list'].split("', '")) if not senator['Agricultura__Ganaderia__Pesca_y_Desarrollo_Rural_initiative_list'] is None or senator['Agricultura__Ganaderia__Pesca_y_Desarrollo_Rural_initiative_list'] == "set()" else 0
                topics["Seguridad Publica"] = len(senator['Seguridad_Publica_initiative_list'].split("', '")) if not senator['Seguridad_Publica_initiative_list'] is None or senator['Seguridad_Publica_initiative_list'] == "set()" else 0
                topics["Reglamentos Parlamentarios"] = len(senator['Reglamentos_y_Practicas_Parlamentarias_initiative_list'].split("', '")) if not senator['Reglamentos_y_Practicas_Parlamentarias_initiative_list'] is None or senator['Reglamentos_y_Practicas_Parlamentarias_initiative_list'] == "set()" else 0
                ...
                topics["Ciencia y tecnologia"] = len(senator['Ciencia_y_Tecnologia_initiative_list'].split("', '")) if not senator['Ciencia_y_Tecnologia_initiative_list'] is None or senator['Ciencia_y_Tecnologia_initiative_list'] == "set()" else 0
                topics["Energia"] = len(senator['Energia_initiative_list'].split("', '")) if not senator['Energia_initiative_list'] is None or senator['Energia_initiative_list'] == "set()" else 0
                ...
                topics["Radio, television y cine"] = len(senator['Radio__Television_y_Cinematografia_initiative_list'].split("', '")) if not senator['Radio__Television_y_Cinematografia_initiative_list'] is None or senator['Radio__Television_y_Cinematografia_initiative_list'] == "set()" else 0
                ...
                topics["Mineria"] = len(senator['Mineria_y_Desarrollo_Regional_initiative_list'].split("', '")) if not senator['Mineria_y_Desarrollo_Regional_initiative_list'] is None or senator['Mineria_y_Desarrollo_Regional_initiative_list'] == "set()" else 0
                topics["Obras publicas"] = len(senator['Comunicaciones_y_Obras_Publicas_initiative_list'].split("', '")) if not senator['Comunicaciones_y_Obras_Publicas_initiative_list'] is None or senator['Comunicaciones_y_Obras_Publicas_initiative_list'] == "set()" else 0
                ...
                topics["Asuntos indigenas"] = len(senator['Asuntos_Indigenas_initiative_list'].split("', '")) if not senator['Asuntos_Indigenas_initiative_list'] is None or senator['Asuntos_Indigenas_initiative_list'] == "set()" else 0
